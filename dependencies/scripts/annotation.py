...
hhsuite_dir = Path('/Users/januszkoszucki/repos/mgg_annotation/test/output/3_ANNOTATION/3_HHSUITE')
main_input = Path('/Users/januszkoszucki/repos/mgg_annotation/test/output/2_ORF_PREDICTION/confident_orfs.csv')

phrogs_tables = Paht(hhsuite_dir, 'PHROGS')
pfam_tables = Paht(hhsuite_dir, 'PFAM')
ecod_tables = Paht(hhsuite_dir, 'ECOD')

# main_input = snakemake.input.main
# phrogs_tables = Path(snakemake.input.phrogs_dir)
# alan_tables = Path(snakemake.input.alan_dir)
# pfam_tables = Path(snakemake.input.pfam_dir)
# ecod_tables = Path(snakemake.input.ecod_dir)
